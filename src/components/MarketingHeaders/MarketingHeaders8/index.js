...
import ElementsSearchBars1 from '../../ElementsSearchBars/SearchBars1';
      ...
      <div className="header-nav-wrapper header-nav-wrapper-lg rounded navbar-light">
        <div className="app-nav-logo flex-grow-0 app-nav-logo--dark mr-3">
          <a
            ...
            <div className="ml-2 text-white font-h">
              <b>Crypto</b>
            </div>
          </a>
        </div>
        <div className="header-nav-menu flex-grow-0 ml-auto d-none d-lg-block">
          <ul className="d-flex justify-content-center">
            ...
            <a
              href="/overview"
              className="font-size-sm text-uppercase text-white font-weight-bold rounded-pill">
           <FontAwesomeIcon
                     icon={['fa', 'home']}
                    className="mr-2"
                  />
            ...
            <li>
              ...
              <a
                href="/explore"
                className="font-weight-bold rounded-lg text-light px-3">
               <FontAwesomeIcon
                      icon={['fas', 'compass']}
                      className="mr-2"
                    />
                    <span className="text-light pr-4">Explore</span>
              </a>
            </li>
          </ul>
        </div>
