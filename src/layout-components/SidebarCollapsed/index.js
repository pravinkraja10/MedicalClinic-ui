            ...
            <ul className="mt-2 sidebar-menu-collapsed">
              <li>
                <Tooltip
                  ...
                  placement="right"
                  title="Chat">
                  <NavLink activeClassName="active" to="/template/PageChat">
                    <span>
              ...
              <li>
                <Tooltip
                  ...
                  placement="right"
                  title="Calendar">
                  <NavLink activeClassName="active" to="/template/PageCalendar">
                    <span>
                      <RoomTwoToneIcon />
                    </span>
                  </NavLink>
              ...
              <li>
                <Tooltip
                  ...
                  placement="right"
                  title="Projects">
                  <NavLink activeClassName="active" to="/template/PageProjects">
                    <span>
              ...
              <li>
                <Tooltip
                  ...
                  placement="right"
                  title="Profile">
                  <NavLink activeClassName="active" to="/template/PageProfile">
                    <span>
                      <FavoriteTwoToneIcon />
                    </span>
                  </NavLink>
